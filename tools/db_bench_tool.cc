...
#include "rocksdb/utilities/report_agent.h"   //yhh::added to import YCSB (source from ADOC)
...
#include "ycsbcore/client.h"         //yhh::added to import YCSB (source from ADOC)
#include "ycsbcore/core_workload.h"  //yhh::added to import YCSB (source from ADOC)
#include "ycsbcore/countdown_latch.h"//yhh::added to import YCSB (source from ADOC)
#include "ycsbcore/db_factory.h"     //yhh::added to import YCSB (source from ADOC)
#include "ycsbcore/measurements.h"   //yhh::added to import YCSB (source from ADOC)
#include "ycsbcore/timer.h"          //yhh::added to import YCSB (source from ADOC)
#include "ycsbcore/utils.h"          //yhh::added to import YCSB (source from ADOC)
...
//yhh::added to import YCSB (source from ADOC) eht267
// for FEAT
...
//yhh::end
  ...
  //yhh::added to import YCSB (source from ADOC) *abe240
  void YCSBWorking(ThreadState* thread, ycsbc::CoreWorkload* workload, int load,
    ...
    if (load) {
      while (!duration.Done(entries_per_batch_)) {
        ...
        //yhh::modified to import YCSB (source from ADOC)
